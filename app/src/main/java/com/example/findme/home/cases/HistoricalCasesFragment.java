...
public class HistoricalCasesFragment extends Fragment implements Database.CollectionUpdateListener {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view =  inflater.inflate(R.layout.fragment_historical_cases, container, false);
